/* Natura Vida V8.0.5 — saneamiento, diagnóstico y calidad de datos.
...
(function(){
  ...
  function systemHealth(){
    ...
    const checks = [
      ...
      { label:'Versión', ok:true, detail:'8.0.5' }
    ];
  ...
  function downloadBackup(){
    const payload = {
      schema:'natura-vida-safe-export', version:'8.0.5', exportedAt:new Date().toISOString(),
    ...
    if (window.writeAudit) writeAudit('backup:export_readonly','system','session',null,{version:'8.0.5'}).catch(()=>{});
  }
