  ...
  main.innerHTML = `
    ...
    <div class="card" style="padding:14px;">
      <p style="font-size:11.5px; color:var(--gray); margin:0 0 12px; line-height:1.6;">
        Genera una copia manual de emergencia. En V6 esta copia NO reemplaza a Supabase ni debe usarse como base principal. Sirve sólo como respaldo auxiliar.
      </p>
    ...
    <div class="card onlineConfigCard" style="padding:14px;">
      <p style="font-size:11.5px; color:var(--gray); margin:0 0 12px; line-height:1.6;">
        Configura Supabase como fuente oficial del sistema. Las cuentas, roles, productos, ventas, clientes y pedidos deben vivir en Supabase. El celular sólo conserva caché temporal y cola offline.
      </p>
      ...
      <div class="field"><label>Supabase Publishable key o anon key</label><input type="password" id="online_key" placeholder="sb_publishable_... o eyJ..." value="${escapeHtml(getOnlineConfigValue ? getOnlineConfigValue('supabaseAnonKey') : '')}"></div>
      <div class="field-row">
    ...
    <div class="card" style="padding:14px;">
      <div class="costline">NATURA VIDA — V6 online-first Supabase</div>
      <div class="costline">Supabase es la base oficial. IndexedDB queda sólo para caché temporal y cola offline.</div>
    </div>
  `;
