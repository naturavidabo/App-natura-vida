...
(() => {
  ...
  async function renderInicioV7() {
    ...
    main.innerHTML = `
      ...
      <section class="v7Panel v7NaturePanel v802NaturePanel">
        <div><span class="v7Eyebrow">Natura Vida V8.0.3</span><h2>Información clara. Operación segura.</h2><p>Una sola base oficial, actualización silenciosa y controles diseñados para trabajar más rápido.</p></div>
  ...
  function renderMasV7() {
    ...
    main.innerHTML = `
      ...
      <div class="v7Version">Natura Vida V${escapeHtml(window.NATURA_APP_VERSION || '8.0.3')} · Supabase · Realtime</div>
    `;
