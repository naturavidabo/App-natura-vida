...
(() => {
  ...
  function listHtml() {
    ...
    return `<section class="v760RouteHero v770RouteHero"><div class="v770OrganicGlow one"></div><div class="v770OrganicGlow two"></div><span class="v7Eyebrow">Natura Vida V8.0.0 XD</span><h1>Distribución y rutas</h1><p>${admin() ? 'Planifica rutas, asigna responsables y fiscaliza entregas con ubicación y evidencia.' : 'Gestiona tus recorridos, confirma visitas y registra entregas desde el celular.'}</p></section>
  ...
  Object.assign(window, { renderDistributionV760, refreshDistributionV760, openRouteDetailV760, handleDistributionRealtimeV770 });
})();
