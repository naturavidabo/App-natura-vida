...
(() => {
  ...
  const BUILD_ID = '2026-07-21-v821-motor-ia-hibrido-seguro';
  ...
  async function installAppUpdateManager() {
    ...
    registration = await navigator.serviceWorker.register('./service-worker.js?v=8.2.1', { updateViaCache: 'none' });
