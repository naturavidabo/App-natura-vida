...
(() => {
  ...
  const BUILD_ID = '2026-07-21-v822-asistente-operativo-afinacion-movil';
  ...
  async function installAppUpdateManager() {
    ...
    registration = await navigator.serviceWorker.register('./service-worker.js?v=8.2.2', { updateViaCache: 'none' });
