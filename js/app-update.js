...
(() => {
  const CURRENT_VERSION = '8.2.3';
  const BUILD_ID = '2026-07-23-v823-autocompletado-intuitivo-chat-organizado-motor-ia-corregido';
  ...
  async function installAppUpdateManager() {
    ...
    registration = await navigator.serviceWorker.register('./service-worker.js?v=8.2.3', { updateViaCache: 'none' });
