...
(() => {
  ...
  const BUILD_ID = '2026-07-20-v820-estados-cuenta-deudas-documentos-cobro';
  ...
  async function installAppUpdateManager() {
    ...
    registration = await navigator.serviceWorker.register('./service-worker.js?v=8.2.0', { updateViaCache: 'none' });
