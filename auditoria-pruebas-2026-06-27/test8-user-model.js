...
async function main() {
  ...
  const founderReg = await founder.registerNewAccount('Cristhian Fundador', 'cristhian@naturavida.com', 'claveSegura1');
  ...
  const repReg = await rep.registerNewAccount('Ana Representante', 'ana@correo.com', 'claveAna123');
  ...
  const repLogin2 = await repDevice2.loginWithEmail('ana@correo.com', 'claveAna123');
  ...
  const repLogin3 = await repDevice3.loginWithEmail('ana@correo.com', 'claveAna123');
  ...
  await rep2.registerNewAccount('Otro Representante', 'otro@correo.com', 'claveOtro123');
  ...
  const blockedLoginAttempt = await createDevice(backend).loginWithEmail('ana@correo.com', 'claveAna123');
  ...
  const unblockedLoginAttempt = await createDevice(backend).loginWithEmail('ana@correo.com', 'claveAna123');
  ...
  // ---------------------------------------------------------------
  const recovery = await founder.requestPasswordRecovery('ana@correo.com');
  ...
  // ---------------------------------------------------------------
  const badEmail = await createDevice(backend).registerNewAccount('Test', 'no-es-correo', 'claveValida1');
  ok('8. Rechaza un correo sin formato válido', badEmail.ok === false);
  const badPass = await createDevice(backend).registerNewAccount('Test', 'test2@correo.com', '123');
