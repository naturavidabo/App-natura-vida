...
checks={
 'version 8.2.0':version.get('version')=='8.3.1',
 'module loaded':'js/v8-offline-continuity.js?v=8.3.1' in index,
...
print(f"Continuidad segura V8.3.1: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
