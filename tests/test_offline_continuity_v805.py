...
checks={
 'version 8.0.7':version.get('version')=='8.0.7',
 'module loaded':'js/v8-offline-continuity.js?v=8.0.7' in index,
 'app shell cache':"APP_CACHE = 'nv-app-shell-v807'" in sw and 'APP_SHELL' in sw,
...
print(f"Continuidad segura V8.0.7: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
