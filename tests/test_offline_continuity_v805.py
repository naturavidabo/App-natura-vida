...
checks={
 'version 8.2.0':version.get('version')=='8.3.0',
 'module loaded':'js/v8-offline-continuity.js?v=8.3.0' in index,
 'app shell cache':"APP_CACHE = 'nv-app-shell-v830'" in sw and 'APP_SHELL' in sw,
...
print(f"Continuidad segura V8.3.0: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
