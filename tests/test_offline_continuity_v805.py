...
checks={
 'version 8.0.6':version.get('version')=='8.0.6',
 'module loaded':'js/v8-offline-continuity.js?v=8.0.6' in index,
 'app shell cache':"APP_CACHE = 'nv-app-shell-v806'" in sw and 'APP_SHELL' in sw,
 ...
 'offline banner':'nv805ConnectivityBanner' in js,
...
print(f"Continuidad segura V8.0.6: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
