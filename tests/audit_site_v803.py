...
require(version.get('version')=='8.4.0','app-version no indica 8.4.0')
require("CURRENT_VERSION = '8.4.0'" in update,'app-update no indica 8.4.0')
require('service-worker.js?v=8.4.0' in update,'registro del service worker no usa 8.4.0')
...
if errors:
    print(f'Auditoría Natura Vida V8.4.0: {checks-len(errors)}/{checks} controles OK')
    for e in errors: print('ERROR:',e)
    sys.exit(1)
print(f'Auditoría Natura Vida V8.4.0: {checks}/{checks} controles OK')
