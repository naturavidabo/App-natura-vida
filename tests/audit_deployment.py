...
require('tests/audit_site_v760.py' in text,'El workflow no ejecuta la auditoría V7.6.0')
require((ROOT/'.node-version').read_text().strip().startswith('24'),'Node 24 no configurado')

print(f'Auditoría de despliegue V7.6.0: {15-len(errors)}/15 controles OK')
if errors:
