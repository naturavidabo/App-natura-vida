...
require('tests/test_territory_registration_v803.py' in text,'workflow no prueba regresión territorial V8.0.4')
...
if errors:
 print(f'Auditoría de despliegue V8.0.4: {checks-len(errors)}/{checks} controles OK')
 for e in errors: print('ERROR:',e)
 sys.exit(1)
print(f'Auditoría de despliegue V8.0.4: {checks}/{checks} controles OK')
