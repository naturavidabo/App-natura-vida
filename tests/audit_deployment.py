...
require('tests/audit_site_v803.py' in text,'workflow no ejecuta auditoría V8.0.3')
...
require('tests/test_territory_registration_v803.py' in text,'workflow no prueba regresión territorial V8.0.3')
...
if errors:
 print(f'Auditoría de despliegue V8.0.3: {checks-len(errors)}/{checks} controles OK')
 for e in errors: print('ERROR:',e)
 sys.exit(1)
print(f'Auditoría de despliegue V8.0.3: {checks}/{checks} controles OK')
