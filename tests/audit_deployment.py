...
require('tests/audit_site_v801.py' in text,'workflow no ejecuta auditoría V8.0.1')
...
if errors:
 print(f'Auditoría de despliegue V8.0.1: {checks-len(errors)}/{checks} controles OK')
 for e in errors: print('ERROR:',e)
 sys.exit(1)
print(f'Auditoría de despliegue V8.0.1: {checks}/{checks} controles OK')
