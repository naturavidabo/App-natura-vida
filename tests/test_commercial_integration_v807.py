...
checks={
 'versión 8.2.0':version.get('version')=='8.2.3',
 'módulo cargado':'js/v8-commercial-rules.js?v=8.2.3' in index,
...
print(f"Integración comercial V8.2.3: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
