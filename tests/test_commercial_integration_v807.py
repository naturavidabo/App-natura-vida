...
checks={
 'versión 8.0.7':version.get('version')=='8.0.7',
 'módulo cargado':'js/v8-commercial-rules.js?v=8.0.7' in index,
...
print(f"Integración comercial V8.0.7: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
