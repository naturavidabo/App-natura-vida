...
checks={
 'versión 8.2.0':version.get('version')=='8.3.0',
 'módulo cargado':'js/v8-commercial-rules.js?v=8.3.0' in index,
...
print(f"Integración comercial V8.3.0: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
