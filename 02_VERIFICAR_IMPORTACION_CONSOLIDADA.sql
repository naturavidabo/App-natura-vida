/* NATURA VIDA V7.2.5 — cuentas por cobrar, egresos/insumos y balance básico. */
...
(function(){
  ...
  function renderFinanceV725(){
    ...
    $('#mainArea').innerHTML=`
      <section class="v7PageHead"><span class="v7Eyebrow">Costos y balance</span><h1>Egresos e insumos</h1><p>Registra materia prima, envases, etiquetas y gastos operativos para tener utilidad estimada.</p></section>
