// NATURA VIDA V8.2.4 — asistente IA estable, continuidad segura y sin cola offline automática.
const VERSION = 'natura-vida-v8-2-4-ia-conectada-estabilidad-formularios';
const APP_CACHE = 'nv-app-shell-v824';
const IMAGE_CACHE = 'nv-images-v3';
const RUNTIME_CACHE = 'nv-runtime-v824';
