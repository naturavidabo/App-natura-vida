// NATURA VIDA V8.2.3 — asistente IA estable, continuidad segura y sin cola offline automática.
const VERSION = 'natura-vida-v8-2-2-asistente-operativo';
const APP_CACHE = 'nv-app-shell-v823';
const IMAGE_CACHE = 'nv-images-v3';
const RUNTIME_CACHE = 'nv-runtime-v823';
