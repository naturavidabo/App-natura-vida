// NATURA VIDA V8.2.1 — asistente IA estable, continuidad segura y sin cola offline automática.
const VERSION = 'natura-vida-v8-2-1-motor-ia-hibrido';
const APP_CACHE = 'nv-app-shell-v821';
const IMAGE_CACHE = 'nv-images-v3';
const RUNTIME_CACHE = 'nv-runtime-v821';
