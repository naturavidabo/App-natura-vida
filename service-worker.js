// NATURA VIDA V8.1.1 — asistente IA estable, continuidad segura y sin cola offline automática.
const VERSION = 'natura-vida-v8-1-1-asistente-ia-estable';
const APP_CACHE = 'nv-app-shell-v811';
const IMAGE_CACHE = 'nv-images-v3';
const RUNTIME_CACHE = 'nv-runtime-v811';
