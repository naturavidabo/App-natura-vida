// NATURA VIDA V8.2.7 — asistente IA estable, continuidad segura y sin cola offline automática.
const VERSION = 'natura-vida-v8-2-7-secretario-operativo-ventas-rendicion-robot-estable';
const APP_CACHE = 'nv-app-shell-v827';
const IMAGE_CACHE = 'nv-images-v3';
const RUNTIME_CACHE = 'nv-runtime-v827';
