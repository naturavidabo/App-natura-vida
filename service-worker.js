// NATURA VIDA V8.2.6 — asistente IA estable, continuidad segura y sin cola offline automática.
const VERSION = 'natura-vida-v8-2-6-pagos-claros-asistente-secretario-altavoz';
const APP_CACHE = 'nv-app-shell-v826';
const IMAGE_CACHE = 'nv-images-v3';
const RUNTIME_CACHE = 'nv-runtime-v826';
